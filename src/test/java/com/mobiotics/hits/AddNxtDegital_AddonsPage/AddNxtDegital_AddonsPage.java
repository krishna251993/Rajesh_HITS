...
public class AddNxtDegital_AddonsPage extends BasePage {
	static final Logger logger = Logger.getLogger(AddNxtDegital_AddonsPage.class);

	public AddNxtDegital_AddonsPage() {
	...
	public void add_Nxt_Pay_Bouquet_Bulk() {
		waitTillElementIsVisible(clickonbullkbutton);
		clickonbullkbutton.click();
		
		logger.info("I have clicked on the bulkButton");
		choosefiletoUpload.sendKeys(System.getProperty("user.dir")+"/ExcelPages/bulkaddonproducttemplate.csv");
